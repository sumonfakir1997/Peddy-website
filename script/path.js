...
const getDisplayAllPets = (petDetails) => {
  ...
  // Check if petContainer exists before manipulating it
  if (!petContainer) {
    console.error("petContainer element not found");
    return;
  }
  ...
  petDetails.forEach((item) => {
    ...
    card.innerHTML = `
      ...
      <div class="card-body p-0">
        <h2 class="card-title pt-4">${item?.pet_name || "card-title"}</h2>
          ...
          <div class="flex gap-2">
            ...
            >
              <g clip-path="url(#clip0_2081_39)">
                <path
                  d="M3.33334 3.33337H8.33334V8.33337H3.33334V3.33337Z"
                  stroke="#5A5A5A"
                  stroke-width="1.5"
                ...
                />
                <path
                  d="M3.33334 11.6666H8.33334V16.6666H3.33334V11.6666Z"
                  stroke="#5A5A5A"
                  stroke-width="1.5"
                  stroke-linecap="round"
                  stroke-linejoin="round"
            ...
            <p >
              Breed:<span>${item?.breed || "Unknown"}</span>
            </p>
          </div>
          <div class="flex gap-2">
...
<rect width="20" height="20" fill="white"/>
        ...
        <div
          class="card-actions justify-between border-t border-gray-200 pt-4"
        >
          ...
          <div
            class="badge badge-outline text-[#0E7A81] cursor-pointer"
          >
            Adopt
          </div>
          <div
